...
cap = cv2.VideoCapture('./video_146.mp4')

mpPose = mp.solutions.pose
pose = mpPose.Pose()
mpDraw = mp.solutions.drawing_utils

model = keras.models.load_model("model/lstm-model.h5")
...
video_writer = cv2.VideoWriter("./output.avi", cv2.VideoWriter_fourcc('m', 'p', '4', 'v'),
